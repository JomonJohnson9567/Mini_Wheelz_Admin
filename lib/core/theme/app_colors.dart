...
class AppColors {
  ...
  static const Color panel = Color(0xFF2A2A2C); // outer panel
  static const Color card = Color(0xFF121214); // inner dark cards
  static const Color accent = Color(0xFFB7F171); // green coin
  static const Color subtle = Color(0xFF606060);
